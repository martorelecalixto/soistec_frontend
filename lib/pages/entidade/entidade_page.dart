...
import 'package:sistrade/models/entidade_model.dart';
import 'package:sistrade/services/entidade_service.dart';
import 'package:sistrade/widgets/entidade_form.dart';
...
class EntidadePage extends StatefulWidget {
  const EntidadePage({super.key});

  @override
  _EntidadePageState createState() => _EntidadePageState();
}
