...
class VendaBilheteScreen extends StatefulWidget {
  const VendaBilheteScreen({
    super.key,
    });

  @override
  _VendaBilheteScreenState createState() => _VendaBilheteScreenState();
}

class _VendaBilheteScreenState extends State<VendaBilheteScreen> {
