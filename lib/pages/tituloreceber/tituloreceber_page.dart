...
class TituloReceberPage extends StatefulWidget {
  const TituloReceberPage({
    super.key,
    });

  @override
  _TituloReceberPageState createState() => _TituloReceberPageState();
}

class _TituloReceberPageState extends State<TituloReceberPage> {
