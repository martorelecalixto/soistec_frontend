...
class ReciboReceberScreen extends StatefulWidget {
  const ReciboReceberScreen({
    super.key,
    });

  @override
  _ReciboReceberScreenState createState() => _ReciboReceberScreenState();
}

class _ReciboReceberScreenState extends State<ReciboReceberScreen> {
