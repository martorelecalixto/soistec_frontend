...
class ReciboReceberPage extends StatefulWidget {
  const ReciboReceberPage({
    super.key,
    });

  @override
  _ReciboReceberPageState createState() => _ReciboReceberPageState();
}

class _ReciboReceberPageState extends State<ReciboReceberPage> {
