...
import '../widgets/entidadeciaaerea_form.dart';
import '../widgets/entidadeoperadora_form.dart';
import '../widgets/entidadevendedor_form.dart';
import '../widgets/entidadeemissor_form.dart';
import '../widgets/entidadehotel_form.dart';
    ...
    return Wrap(
      ...
      children: [
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: Colors.white,//Colors.purple[200],
            foregroundColor: Colors.white,
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: Colors.white,//Colors.purple[300],
            foregroundColor: Colors.white,
       ...
       ElevatedButton(
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: Colors.white,// Colors.deepPurpleAccent[200],
            foregroundColor: Colors.white,
        ...
        ElevatedButton(
          onPressed: ((habilitaSalvarCancelar)&&(isLocadora)) ? onNovo : null,
          style: ElevatedButton.styleFrom(
            backgroundColor: Colors.white,// Colors.deepPurpleAccent[100],
            foregroundColor: Colors.white,
