...
class AtividadeForm extends StatefulWidget {
  ...
  const AtividadeForm({super.key, this.atividade});
...
class _AtividadeFormState extends State<AtividadeForm> {
  ...
  void _salvar() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (widget.atividade == null) {
        //print('ENTROU INSERT');
        sucesso = await AtividadeService.createAtividade(atividade);
      } else {
        //print('ENTROU UPDATE');
        sucesso = await AtividadeService.updateAtividade(atividade);
      }
