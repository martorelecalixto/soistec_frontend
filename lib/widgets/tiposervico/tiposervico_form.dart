...
class TipoServicoForm extends StatefulWidget {
  final TipoServico? tiposervico;
  const TipoServicoForm({super.key, this.tiposervico});

  @override
  _TipoServicoFormState createState() => _TipoServicoFormState();
}

class _TipoServicoFormState extends State<TipoServicoForm> {
  ...
  void initState() {
    super.initState();
    if (widget.tiposervico != null) {
      final f = widget.tiposervico!;
  ...
  void _salvar() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (widget.tiposervico == null) {
        //print('ENTROU INSERT');
        sucesso = await TipoServicoService.createTipoServicoHoteis(tiposervico);
      } else {
        //print('ENTROU UPDATE');
        sucesso = await TipoServicoService.updateTipoServicoHoteis(tiposervico);
      }
